...
static const char *fonts[]          = { "System San Francisco Display:size=9:bold:antialias=true:autohint=true" };
...
static const char col_orange[]        = "#b54b09";
static const char bg_color[]        = "#e66e1e";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
	[SchemeSel]  = { col_gray4, col_gray1,  col_orange  },
	[SchemeStatus]  = { bg_color, bg_color,  "#000000"  }, // Statusbar right {text,background,not used but cannot be empty}
...
static const Key keys[] = {
	...
	{ControlMask | Mod1Mask |ShiftMask,             XK_q,      quit,           {0} },
